...
class Test_Demo_Models(unittest.TestCase):
	...
	def test_demo_model_v2(self):
		fixture = TestFixture(self, "test/reference_output/", "output_files_v2/", "input_files_v2/input.yml")
		fixture.clear_output_directory()
	...
	def test_demo_model_v2_yaml(self):
		fixture = TestFixture(self, "test/reference_output/", "output_files_v2_yml/", "input_files_v2_yml/input.yml")
		fixture.clear_output_directory()
