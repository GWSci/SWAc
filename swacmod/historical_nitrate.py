...
def _calculate_historical_nitrate(blackboard):
	...
	blackboard.historic_proportion_reaching_water_table_array_per_day = blackboard.historic_proportion_reaching_water_table_array_per_day[len(blackboard.truncated_historical_nitrate_days) :]
