...
def calculate_nitrate(data, output, node, logging = logging):
	...
	if "enabled" == params["nitrate_process"]:
		...
		m3_array_kg_per_day = _calculate_m3_array_kg_per_day(m0_array_kg_per_day, her_array_mm_per_day, Psmd, Pro)
...
def _calculate_m3_array_kg_per_day(m0_array_kg_per_day, her_array_mm_per_day, Psmd, Pro):
