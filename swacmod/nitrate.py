...
def calculate_nitrate(data, output, node, logging = logging):
	...
	if "enabled" == params["nitrate_process"]:
		...
		m1_array_kg_per_day = _calculate_m1_array_kg_per_day(Psoilperc, m0_array_kg_per_day, M_soil_tot_kg, M_soil_in_kg)
...
def _calculate_m1_array_kg_per_day(Psoilperc, m0_array_kg_per_day, M_soil_tot_kg, M_soil_in_kg):
