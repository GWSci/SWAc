...
def make_sample_input_directory():
    # to mimic os.listdir()
    return [
        'node_areas.yml',
        'node_xy.csv',
        'time_periods.csv',
        'rch_nodes.csv',
        'reporting_zone_mapping.yml',
        'reporting_zone_names.yml',
        'rainfall_zone_mapping.yml',
        'rainfall_zone_names.yml',
        'pe_zone_mapping.yml',
        'pe_zone_names.yml',
        'temperature_zone_mapping.yml',
        'temperature_zone_names.yml',
        'tmax_c_zone_mapping.yml',
        'tmax_c_zone_names.yml',
        'tmin_c_zone_mapping.yml',
        'tmin_c_zone_names.yml',
        'windsp_zone_mapping.yml',
        'windsp_zone_names.yml',
        'subroot_zone_mapping.yml',
        'subroot_zone_names.yml',
        'rapid_runoff_zone_mapping.yml',
        'rapid_runoff_zone_names.yml',
        'swrecharge_zone_mapping.yml',
        'swrecharge_zone_names.yml',
        'macropore_zone_mapping.yml',
        'macropore_zone_names.yml',
        'soil_zone_names.yml',
        'landuse_zone_names.yml',
        'canopy_zone_mapping.yml',
        'canopy_zone_names.yml',
        'free_throughfall.yml',
        'max_canopy_storage.yml',
        'snow_params.yml',
        'snow_params_complex.yml',
        'rapid_runoff_params.yml',
        'swrecharge_proportion.yml',
        'swrecharge_limit.yml',
        'macropore_proportion.yml',
        'macropore_limit.yml',
        'macropore_activation.yml',
        'macropore_recharge.yml',
        'soil_static_params.yml',
        'smd.yml',
        'soil_spatial.yml',
        'lu_spatial.yml',
        'zr.yml',
        ...
        'taw.yml',
        'raw.yml',
        'percolation_rejection.yml',
        'percolation_rejection_ts.yml',
        'subroot_leakage_fraction.yml',
        'interflow_zone_mapping.yml',
        'interflow_zone_names.yml',
        'init_interflow_store.yml',
        'interflow_store_bypass.yml',
        'infiltration_limit.yml',
        'interflow_decay.yml',
        'infiltration_limit_ts.yml',
        'interflow_decay_ts.yml',
        'recharge_attenuation_params.yml',
        'mu.csv',
        'effective_porosity.csv',
        'Average_DTW.csv',
        'NO3_loading.csv',
        'sw_params.yml',
        'sw_zone_mapping.yml',
        ...
        'sw_downstream.yml',
        'sw_activation.yml',
        'sw_bed_infiltration.yml',
        'sw_direct_recharge.yml',
        'sw_pe_to_open_water.yml',
        'sw_ponding_area.yml',
        'routing_parameters.csv',
        'swdis_ts.csv',
        'swdis_locs.yml',
        'swabs_ts.csv',
        'swabs_locs.csv',
