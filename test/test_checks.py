...
class MyTestCase(unittest.TestCase):
    ...
    def test_list_length_when_param_is_not_a_list(self):
        self.assert_validate_list_length_passes("a", [list], [3])
    ...
    def test_list_length_when_len_list_length_differs(self):
        ...
        self.assert_validate_list_length_fails(["a", "b", "c"], [list], [2])

    def test_list_length_when_len_list_length_matches_nested_lists(self):
        self.assert_validate_list_length_passes([["a", "b", "c"], ["d", "e", "f"]], [list, list], [2, 3])

    def test_list_length_when_len_list_length_differs_nested_lists(self):
        self.assert_validate_list_length_fails([["a", "b", "c"], ["d", "e"]], [list, list], [2, 3])
    ...
    def test_list_length_when_len_list_length_matches_list_dict_list(self):
        self.assert_validate_list_length_passes(
            [
                {
                    "x": ["a", "b", "c"],
    ...
    def test_list_length_when_len_list_length_differs_list_dict_list(self):
        self.assert_validate_list_length_fails(
            [
                {
                    "x": ["a", "b", "c"],
