...
class Test_Nitrate_Mass_Balance(unittest.TestCase):
	def test_calculate_m3_array_kg_per_day(self):
		her_array_mm_per_day = np.array([1.0, 1.0, 1.0, 1.0, 0.0])
		pp = np.array([0.0, 0.5, 0.0, 0.3, 0.3])
		p_non = np.array([0.0, 0.0, 2.0/3.0, 0.2, 0.2])
		m0_array_kg_per_day = np.array([2.0, 6.0, 15.0, 14.0, 14.0])
		expected = np.array([2.0, 3.0, 5.0, 7.0, 0.0])
