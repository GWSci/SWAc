...
class Test_Nitrate(unittest.TestCase):
	...
	def test_calculate_nitrate(self):
		...
		np.testing.assert_array_almost_equal(np.array([25.0, 0.0]), actual["m4_array_kg_per_day"])
		np.testing.assert_array_almost_equal(np.array([0.0, 10.0]), actual["m4out_array_kg_per_day"])
